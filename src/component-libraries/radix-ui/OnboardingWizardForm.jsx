      ...
      <Flex direction="column" gap="3">
        ...
        {step === 1 && (
          <>
            ...
            <Box>
              <Text as="label" size="2" weight="medium" htmlFor="onboard-email">
                Email address
              </Text>
              <TextField.Root
                id="onboard-email"
        ...
        {step === 2 && (
          <>
            ...
            <Box>
              <Text as="label" size="2" weight="medium" htmlFor="onboard-role">
                Your role
              </Text>
              <Select.Root name="role">
                <Select.Trigger id="onboard-role" placeholder="Select role" />
                <Select.Content>
            ...
            <Box>
              <Text
                ...
                size="2"
                weight="medium"
                htmlFor="onboard-team-size"
              >
                Team size
              </Text>
              <Select.Root name="teamSize">
                <Select.Trigger
                  id="onboard-team-size"
        ...
        {step === 3 && (
          <>
            <Box>
              <Text as="label" size="2" weight="medium" htmlFor="onboard-goals">
                What are your goals?
              </Text>
              <TextArea
                id="onboard-goals"
            ...
            <Box>
              <Text
                ...
                size="2"
                weight="medium"
                htmlFor="onboard-hear-about"
              >
                How did you hear about us?
              </Text>
              <Select.Root name="hearAbout">
                <Select.Trigger id="onboard-hear-about" placeholder="Select" />
                <Select.Content>
