...
<Field.Root required className="base-field">
        ...
        <select className="base-select" name="topic" defaultValue="general" required>
...
<Field.Root required className="base-field">
        ...
        <Field.Control render={<textarea />} className="base-textarea" name="message"  rows={4} required />
      </Field.Root>
<button type="submit" className="base-button">Send inquiry</button>
    </form>
  )
}