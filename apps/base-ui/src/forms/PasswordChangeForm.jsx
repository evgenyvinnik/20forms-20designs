...
export default function PasswordChangeForm() {
  ...
  return (
    <form onSubmit={handleSubmit} className="base-form">
      ...
      <Field.Control className="base-input" name="currentPassword" type="password"     required />
      
    </Field.Root>
<Field.Root required className="base-field">
      <Field.Label className="base-label">New password</Field.Label>
      <Field.Control className="base-input" name="newPassword" type="password"     required />
...
<button type="submit" className="base-button">Update password</button>
    </form>
  )
}