...
<Field.Root required className="base-field">
        ...
        <select className="base-select" name="service" defaultValue="consultation" required>
...
<Field.Root required className="base-field">
      ...
      <Field.Control className="base-input" name="date" type="date"     required />
      
    </Field.Root>
<Field.Root  className="base-field">
        <Field.Label className="base-label">Notes</Field.Label>
        <Field.Control render={<textarea />} className="base-textarea" name="notes"  rows={3}  />
      </Field.Root>
<button type="submit" className="base-button">Request appointment</button>
    </form>
  )
}