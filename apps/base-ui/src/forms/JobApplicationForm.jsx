...
<Field.Root required className="base-field">
      ...
      <Field.Control className="base-input" name="phone" type="tel"     required />
      
    </Field.Root>
<Field.Root required className="base-field">
        <Field.Label className="base-label">Cover letter</Field.Label>
        <Field.Control render={<textarea />} className="base-textarea" name="coverLetter"  rows={4} required />
      </Field.Root>
<button type="submit" className="base-button">Submit application</button>
    </form>
  )
}