...
<Field.Root required className="ark-field">
        ...
        <select className="ark-select" name="topic" defaultValue="general" required>
...
<Field.Root required className="ark-field">
        ...
        <Field.Textarea className="ark-textarea" name="message"  rows={4} required />
      </Field.Root>
<button type="submit" className="ark-button">Send inquiry</button>
    </form>
  )
}