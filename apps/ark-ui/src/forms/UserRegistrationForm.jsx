...
export default function UserRegistrationForm() {
  ...
  return (
    <form onSubmit={handleSubmit} className="ark-form">
      ...
      <Field.Input className="ark-input" name="fullName" type="text"     required />
...
<Field.Root required className="ark-field">
      ...
      <Field.Input className="ark-input" name="username" type="text"     required />
      
    </Field.Root>
<Field.Root required className="ark-field">
      <Field.Label className="ark-label">Password</Field.Label>
      <Field.Input className="ark-input" name="password" type="password"     required />
...
<button type="submit" className="ark-button">Create account</button>
    </form>
  )
}