...
export default function SupportTicketForm() {
  ...
  return (
    <form onSubmit={handleSubmit} className="ark-form">
      ...
      <Field.Input className="ark-input" name="subject" type="text"     required />
      
    </Field.Root>
<Field.Root required className="ark-field">
        <Field.Label className="ark-label">Priority</Field.Label>
        <select className="ark-select" name="priority" defaultValue="medium" required>
...
<Field.Root required className="ark-field">
        ...
        <Field.Textarea className="ark-textarea" name="description"  rows={4} required />
      </Field.Root>
<button type="submit" className="ark-button">Submit ticket</button>
    </form>
  )
}