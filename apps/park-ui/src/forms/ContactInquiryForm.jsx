...
<Field.Root required className="park-field">
        ...
        <select className="park-select" name="topic" defaultValue="general" required>
...
<Field.Root required className="park-field">
        ...
        <Field.Textarea className="park-textarea" name="message"  rows={4} required />
      </Field.Root>
<button type="submit" className="park-button">Send inquiry</button>
    </form>
  )
}